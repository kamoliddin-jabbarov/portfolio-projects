...
Select * from Advance
-------------------IPD--------------------------
Select * from Patient where PatientId=8848 
Select * from Visit where PatientId=8848 
Select * from Admission where AdmissionId=14
Select * from Charge where AdmissionId=14
Select * from Bill  where AdmissionId=14
Select * from Discharge where AdmissionId=14
-----------------Service 
